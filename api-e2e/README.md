...
| FC21(docs/adr/0026) | `scenarios/points-query.e2e.test.ts`, `scenarios/transfer-fee-and-points.e2e.test.ts` | 実装済み(`GET /customers/me/points/history`が付与/充当/返却それぞれ正しい種別・金額・transferIdで返すこと、未認証401を検証) |
